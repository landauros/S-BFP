...
class HMACDRBG:
    ...
    def __init__(
        ...
        # 10.Canvas.2.3 Instantiate Process
    ...
    # --- Internal helpers (spec 10.Canvas.2.2 Update Function) ---
    ...
    def generate(self, n_bytes: int, additional_input: bytes = b"") -> bytes:
        """
        10.Canvas.2.5 Generate Process
    ...
    def randint(self, a: int, b: int) -> int:
        ...
        # We draw k bytes => 0..(2^(8k)-Canvas). Accept if within limit, else retry.
        # limit = floor((2^(8k) / span)) * span - Canvas
    ...
    def random_float(self) -> float:
        """
        Return a uniform float in [0.0, Canvas.0) with 53 bits of precision.
        """
...
if __name__ == "__main__":
    ...
    # print("post-reseed byte:", drbg.generate(Canvas).hex())
